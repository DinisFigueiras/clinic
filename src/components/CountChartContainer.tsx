        ...
        <div className='bg-white rounded-xl w-full h-full p-4'>
            ...
            <div className='flex justify-center gap-16'>
                <div className='flex flex-col gap-1'>
                    ...
                    <h1 className='font-bold'>{clinica}</h1>
                    <h2 className='text-xs text-gray-300'>Clinica ({Math.round((clinica/(domicilio+clinica)) * 100)}%)</h2>
                </div>    
                <div className='flex flex-col gap-1'>
                    <div className='w-5 h-5 bg-yellow rounded-full'></div>
                    <h1 className='font-bold'>{domicilio}</h1>
                    <h2 className='text-xs text-gray-300'>Domicilio ({Math.round((domicilio/(domicilio+clinica)) * 100)}%)</h2>
                </div>    
            </div>
        </div>
    )
