        ...
        <ResponsiveContainer width="100%" height="90%">
          <BarChart width={500} height={300} data={data} barSize={20}>
              ...
              <Legend
                ...
                formatter={(value) => (
                    <div className="inline-block bg-neutralLight border border-black rounded px-2 py-1 font-bold">
                        {value}
                    </div>
                )}
              />
              <Bar dataKey="Clinica" stackId="a" fill="#6fb5ff" legendType='circle' />
              <Bar dataKey="Domicilio" stackId="a" fill="#ffce99" legendType='circle'radius={[10,10,0,0]}/>
          </BarChart>
        </ResponsiveContainer>
    </div>
    )
